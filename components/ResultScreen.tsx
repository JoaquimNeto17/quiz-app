      ...
      <View style={[styles.page, compact && styles.pageCompact]}>
        ...
        <View style={[styles.main, compact && styles.mainCompact]}>
          ...
          <View style={styles.actions}>
            ...
            >
              <Ionicons color="#17324D" name="home-outline" size={18} />
...
const styles = StyleSheet.create({
  ...
  header: { alignItems: 'center', borderBottomColor: '#D7D0C3', borderBottomWidth: 1, flexDirection: 'row', gap: 11, paddingBottom: 14 },
  mark: { alignItems: 'center', backgroundColor: '#17324D', height: 40, justifyContent: 'center', width: 40 },
  markText: { color: '#F3EFE6', fontFamily: 'serif', fontSize: 22, fontWeight: '900' },
  brand: { color: '#17324D', fontSize: 12, fontWeight: '900', letterSpacing: 1.2 },
  brandCaption: { color: '#9B3E32', fontSize: 7, fontWeight: '800', letterSpacing: 1.4, marginTop: 2 },
  ...
  eyebrowLine: { backgroundColor: '#9B3E32', height: 2, width: 24 },
  eyebrow: { color: '#9B3E32', fontSize: 8, fontWeight: '900', letterSpacing: 1.5 },
  resultRow: { alignItems: 'center', flexDirection: 'row', marginTop: 18 },
  percentageBlock: { alignItems: 'flex-start', flexDirection: 'row' },
  percentage: { color: '#17324D', fontFamily: 'serif', fontSize: 92, fontWeight: '900', letterSpacing: -4, lineHeight: 100 },
  percentageCompact: { fontSize: 62, lineHeight: 68 },
  percentSign: { color: '#9B3E32', fontFamily: 'serif', fontSize: 22, fontWeight: '900', marginLeft: 3, marginTop: 12 },
  resultDivider: { backgroundColor: '#C9C1B5', height: 90, marginHorizontal: 30, width: 1 },
  resultCopy: { flex: 1 },
  title: { color: '#17324D', fontFamily: 'serif', fontSize: 31, fontWeight: '900', lineHeight: 36 },
  titleCompact: { fontSize: 23, lineHeight: 27 },
  message: { color: '#687276', fontSize: 12, lineHeight: 19, marginTop: 6, maxWidth: 430 },
  stats: { borderBottomColor: '#CFC7BA', borderBottomWidth: 1, borderTopColor: '#CFC7BA', borderTopWidth: 1, flexDirection: 'row', justifyContent: 'space-around', marginTop: 22, paddingVertical: 15 },
  stat: { alignItems: 'center', flex: 1 },
  statValue: { color: '#17324D', fontFamily: 'serif', fontSize: 24, fontWeight: '900' },
  statLabel: { color: '#7F8586', fontSize: 7, fontWeight: '900', letterSpacing: 1, marginTop: 3, textAlign: 'center' },
  statRule: { backgroundColor: '#D4CDC1', width: 1 },
  note: { alignItems: 'baseline', flexDirection: 'row', gap: 10, marginTop: 17 },
  noteNumber: { color: '#9B3E32', fontFamily: 'serif', fontSize: 18, fontWeight: '900' },
  noteText: { color: '#697376', flex: 1, fontSize: 10, lineHeight: 15 },
  actions: { flexDirection: 'row', gap: 10, marginTop: 21 },
  primaryButton: { alignItems: 'center', backgroundColor: '#9B3E32', flexDirection: 'row', gap: 12, minHeight: 48, paddingHorizontal: 20 },
  primaryButtonText: { color: '#FFFFFF', fontSize: 12, fontWeight: '900' },
  secondaryButton: { alignItems: 'center', borderColor: '#BEB6A9', borderWidth: 1, flexDirection: 'row', gap: 9, minHeight: 48, paddingHorizontal: 18 },
  secondaryButtonText: { color: '#17324D', fontSize: 12, fontWeight: '900' },
